 ...
 * Compile with:
 *
 * clang -fPIC frida-gum-example.c -o frida-gum-example -L. -lfrida-gum -lresolv -lm -isysroot "$(xcrun --sdk macosx --show-sdk-path)" -arch x86_64 -Wl,-dead_strip
 *
...
// {
//     g_print ("enter pm_dlist_init\n");
// }

// static
// void pm_dlist_class_init (PMDListClass *klass)
// {
//     g_print ("enter pm_dlist_class_init!\n");
// }

static void
example_follow_me_should_support_nullable_event_sink (void)
{
    g_setenv("GOBJECT_DEBUG","true",true);
    // gobject_init();
    gum_init_embedded ();//很重要
...
//   gpointer p;
  ...
  example_follow_me_should_support_nullable_event_sink();
  return 0;
}
